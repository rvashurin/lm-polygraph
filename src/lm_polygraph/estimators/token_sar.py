...
class TokenSARSample(Estimator):
    """
    ...
    def __init__(self, verbose: bool = False):
        super().__init__(["stoken_similarity", "sgreedy_log_likelihoods"], "sequence")
        self.verbose = verbose

    def __str__(self):
        return "TokenSARSample"
    ...
    def __call__(self, stats: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        """
        batch_log_likelihoods = stats["sgreedy_log_likelihoods"]
        batch_token_similarity = stats["stoken_similarity"]
