...
class MeanConditionalPointwiseMutualInformationSample(Estimator):
    """
    ...
    def __init__(self, tau: float = 0.0656, lambd: float = 3.599):
        ...
        """
        super().__init__(
            ["sgreedy_log_likelihoods", "sgreedy_lm_log_likelihoods", "sentropy"],
            "sequence",
        )
        self.tau = tau
        self.lambd = lambd
    ...
    def __str__(self):
        return "MeanConditionalPointwiseMutualInformationSample"
    ...
    def __call__(self, stats: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        """
        logprobs = stats["sgreedy_log_likelihoods"]
        lm_logprobs = stats["sgreedy_lm_log_likelihoods"]
        entropies = stats["sentropy"]
        mi_scores = []
